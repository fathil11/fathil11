                            ...
                            <div class="row mb-4">
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <input name="phone" value="<?php echo e($person->phone); ?>" type="text"
                                            class="form-control">
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="row mb-4">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input name="track" value="<?php echo e($person->track); ?>" type="text"
                                            class="form-control">
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input name="vehicle" value="<?php echo e($person->vehicle); ?>" type="text"
                                            class="form-control">
                                    </div>
                                </div>
                            </div>
                            <div class="row mb-4">
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <input name="village" value="<?php echo e($person->village); ?>" type="text" id="village"
                                            class="form-control">
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <input name="sub_village" value="<?php echo e($person->sub_village); ?>" type="text"
                                            class="form-control">
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <input name="phenomenon" value="<?php echo e($person->phenomenon); ?>" type="text"
                                            class="form-control">
                                    </div>
                                </div>
                            </div>
                                                        ...
                                                        <div class="row justify-content-center mb-2">
                                                            <div class="form-check form-check-radio form-check-inline">
                                                                <label class="form-check-label">
                                                                    <input class="form-check-input" type="radio"
                                                                        name="transmission"
                                                                        <?php echo e($person->transmission == "1" ? 'checked' : ''); ?>
                                                            ...
                                                            <div class="form-check form-check-radio form-check-inline">
                                                                <label class="form-check-label">
                                                                    <input class="form-check-input" type="radio"
                                                                        name="transmission"
                                                                        <?php echo e($person->transmission == "0" ? 'checked' : ''); ?>
                                                            ...
                                                            <div class="form-check form-check-radio form-check-inline">
                                                                <label class="form-check-label">
                                                                    <input class="form-check-input" type="radio"
                                                                        name="transmission"
                                                                        <?php echo e($person->transmission == "2" ? 'checked' : ''); ?>
                                                        ...
                                                        <div class="row justify-content-center mb-2">
                                                            <div class="form-check form-check-radio form-check-inline">
                                                                <label class="form-check-label">
                                                                    <input class="form-check-input" type="radio"
                                                                        name="status"
                                                                        <?php echo e($person->status == "Pendatang" ? 'checked' : ''); ?>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u6434366/public_html/xProductionx/covid-2020/resources/views/admin/editPerson.blade.php ENDPATH**/ ?>